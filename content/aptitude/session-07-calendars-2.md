# Session 7 — Calendars-2: Year Repetition & Calendar Twins
...
- **The advancement rule — the foundation for everything today.** *"A normal year pushes every date's weekday forward by 1 day. A leap year pushes it forward by 2 days."* This is exactly the odd-days idea from Session 6, just renamed for this context.
...
- **The trap, stated directly:** *"Every one of today's shortcuts assumes leap years follow the simple 4-year rhythm — 2016, 2020, 2024, 2028. But you already know from Session 6 that this rhythm breaks at century years like 1900 and 2100, which are NOT leap years despite being divisible by 4."*
...
Scan responses on the way out — if the offset-case identification step is shaky, revisit briefly at the start of Session 8 (Data Interpretation begins a new topic, so this is a light check, not a full re-teach).
...
Tell them: *"That completes the Calendars arc — finding any date's weekday, and now finding when a whole year repeats. Session 8 moves into Data Interpretation — reading and calculating from tables."*
...
- **Data note:** no source slide deck exists. Content sourced from a text extraction of the Concept Explanation/Introduction/Closure sections. The "Problem Solving" sub-page is image-only and unrecoverable — all worked/practice problems in this plan are **instructor-authored**.
...
- **Century-exception content (Teaching Block B, Activity 2) is instructor-added, not from the source extraction** — the source's Ideal Format page mentions "common pitfalls and mistakes" without detailing them; this plan supplies the single most exam-relevant pitfall (century-year breaks) grounded directly in the leap year rule already taught in Session 6.
...
- **Last of the two Calendars sessions** — Session 8 begins a new topic (Data Interpretation) with a diagnostic-style opening, not deep retrieval.
