...
**Duration** 50 min total — 43 min instruction + 7 min Classroom Quiz · **Topic** Stack — Largest Rectangle in Histogram (NSE/PSE two-pass approach + optimal one-pass approach) · **Prerequisite** Asteroid Collision
