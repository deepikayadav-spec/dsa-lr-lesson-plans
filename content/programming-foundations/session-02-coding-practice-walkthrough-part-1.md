...
**Duration** 31 min total — 26 min instruction + 5 min Classroom Quiz · **Topic** Introduction to Python — attacking a coding problem: Read, Restate, Write, Run · **Prerequisite** Programming with Python
...
## Warm-Up Poll — Retrieval Practice on Programming with Python (0–4 min) · ALS: Polling
...
## ⚡ Active Learning Strategy 1 — Guided Construction: Fill the Blank Live (16–21 min)
...
## ⚡ Active Learning Strategy 2 — Round-Robin Trace: Human Compiler (21–26 min)
